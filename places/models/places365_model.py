...
class Places365Model(PlacesModel):
    ...
    def __init__(self):
        ...
        self.scence_cat_num =  self.config.get_places_scene_cats() # int(os.getenv('PLACES_SCENE_CATS', '5'))
        self.scene_attrib_num =  self.config.get_places_scene_attrs() # int(os.getenv('PLACES_SCENE_ATTRS', '5'))
